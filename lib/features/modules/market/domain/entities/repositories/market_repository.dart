...
abstract class MarketRepository {
  ...
  Future<MarketAssumptionModel> updateAssumption(String companyId, MarketAssumptionModel assumption);
  
  Future<SalesProjectionModel?> getProjection(String companyId);
  
  Future<SalesProjectionModel> generateProjection(String companyId);
