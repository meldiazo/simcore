...
class OrganizationCapacityPage extends StatelessWidget {
  const OrganizationCapacityPage({super.key});
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        const PageIntro(
          title: 'Capacidad operativa organizacional',
          subtitle:
            ...
            ConstrainedBox(
              ...
              child: Column(
                children: [
                  ...
                  GlassPanel(
                    backgroundColor:
                        SimcoreColors.warningSoft.withValues(alpha: 0.45),
                    child: const Row(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
